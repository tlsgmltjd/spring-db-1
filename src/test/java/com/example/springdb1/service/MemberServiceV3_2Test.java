...
class MemberServiceV3_2Test {
    ...
    void before() {
        ...
        memberServiceV3_2 = new MemberServiceV3_2(txm, memberRepositoryV3);
    }
    ...
    void accountTransferEx() throws SQLException {
        ...
        // when
        log.info("===============================");
        Assertions.assertThatThrownBy(() -> memberServiceV3_2.accountTransfer(memberA.getMemberId(), memberB.getMemberId(), 2000))
